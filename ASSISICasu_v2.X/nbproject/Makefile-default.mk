...
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1799869156/digitalIO.o ${OBJECTDIR}/_ext/26830128/timer1.o ${OBJECTDIR}/_ext/26830128/timerFunctions.o ${OBJECTDIR}/_ext/732977888/initizializeHardware.o ${OBJECTDIR}/_ext/732977888/main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1799869156/digitalIO.o.d ${OBJECTDIR}/_ext/26830128/timer1.o.d ${OBJECTDIR}/_ext/26830128/timerFunctions.o.d ${OBJECTDIR}/_ext/732977888/initizializeHardware.o.d ${OBJECTDIR}/_ext/732977888/main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1799869156/digitalIO.o ${OBJECTDIR}/_ext/26830128/timer1.o ${OBJECTDIR}/_ext/26830128/timerFunctions.o ${OBJECTDIR}/_ext/732977888/initizializeHardware.o ${OBJECTDIR}/_ext/732977888/main.o
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/ASSISICasu_v2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/732977888/initizializeHardware.o: ../test/CASU-karlo/initizializeHardware.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/732977888 
	@${RM} ${OBJECTDIR}/_ext/732977888/initizializeHardware.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../test/CASU-karlo/initizializeHardware.c  -o ${OBJECTDIR}/_ext/732977888/initizializeHardware.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/732977888/initizializeHardware.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -omf=elf -O0 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/_ext/732977888/initizializeHardware.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/_ext/732977888/main.o: ../test/CASU-karlo/main.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/732977888 
	@${RM} ${OBJECTDIR}/_ext/732977888/main.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../test/CASU-karlo/main.c  -o ${OBJECTDIR}/_ext/732977888/main.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/732977888/main.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -omf=elf -O0 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/_ext/732977888/main.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/_ext/732977888/initizializeHardware.o: ../test/CASU-karlo/initizializeHardware.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/732977888 
	@${RM} ${OBJECTDIR}/_ext/732977888/initizializeHardware.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../test/CASU-karlo/initizializeHardware.c  -o ${OBJECTDIR}/_ext/732977888/initizializeHardware.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/732977888/initizializeHardware.o.d"      -g -omf=elf -O0 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/_ext/732977888/initizializeHardware.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/_ext/732977888/main.o: ../test/CASU-karlo/main.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/732977888 
	@${RM} ${OBJECTDIR}/_ext/732977888/main.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../test/CASU-karlo/main.c  -o ${OBJECTDIR}/_ext/732977888/main.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/732977888/main.o.d"      -g -omf=elf -O0 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/_ext/732977888/main.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
dist/${CND_CONF}/${IMAGE_TYPE}/ASSISICasu_v2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/ASSISICasu_v2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -omf=elf -Wl,--defsym=__MPLAB_BUILD=1,--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_ICD3=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 

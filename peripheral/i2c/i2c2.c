...
UINT16 i2c2_rx_head = 0;                  // pointer to buffer element where new byte is to be stored
UINT8 i2c2_tx_buff[BUFF_SIZE] = {0};     // buffer for outgoing data
UINT16 i2c2_tx_head = 0;                  // pointer to a buffer element which will be send in next outgoing transmission

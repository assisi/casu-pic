...
extern UINT8 ctlPeltier, pwmMotor, pwmR_ctl, pwmG_ctl, pwmB_ctl, pwmR_diag, pwmG_diag, pwmB_diag;  // control inputs to Peltier, vibe motor, RGB led for controlling bees and RGB led for diagnostics
